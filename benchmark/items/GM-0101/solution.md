...
3. $\triangle OAP\cong\triangle OCP\Rightarrow \angle OCP=\angle OAP=90^\circ$，得 $PC$ 是切线
4. 由 $\triangle OAP$ 求 $OP=2\sqrt{5}$，用 $\triangle OAP\sim\triangle$ 关系得 $BC=4\sqrt{5}/5$
5. 建系（$O$ 为原点，半径 $2$，$P(-2,4)$）求 $E=DP\cap OC$，得 $\tan\angle PEC=24/7$
...
4. （5 分）求出 $E$ 点位置并算出 $\tan\angle PEC=\dfrac{24}{7}$
